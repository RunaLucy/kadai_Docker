...
require_once 'Sample1_Error.php';
require_once 'Sample1_ActionClass.php';
require_once 'Sample1_ActionForm.php';
require_once 'Sample1_ViewClass.php';
require_once 'Sample1_UrlHandler.php';

/**
 *  Sample1 application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Sample1
...
class Sample1_Controller extends Ethna_Controller
{
    ...
    public $class = array(
        ...
        'form'          => 'Sample1_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'view'          => 'Sample1_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Sample1_UrlHandler',
    );
